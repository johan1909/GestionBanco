...
public class Banco {
    ...
    boolean existeEnClientes = clientes.stream()
        .anyMatch(c -> c.getEmail().equals(email) && c.getContraseña().equals(contraseña));
    
    // Si no está en clientes, verificar en empleados
    if (!existeEnClientes) {
        return empleados.stream()
            .anyMatch(e -> e.getEmail().equals(email) && e.getContraseña().equals(contraseña));
    }
